          ...
          <div className="p1 flex max-sm:mx-4 max-lg:flex-col max-lg:m-8  lg:mx-auto bg-white  rounded-lg max-sm:flex-col">
            ...
            <div className="p-text w-full  max-lg:p-8  m-auto">
              ...
              <div className="buttons flex lg:mb-6 max-lg:pb-4 gap-3 flex-wrap">
                <button className="bg-transparent hover:bg-blue-800 text-blue-700 font-semibold hover:text-white  py-1 px-4 border border-blue-500 hover:border-transparent rounded">
                  react
                </button>
                <button className="bg-transparent hover:bg-blue-800 text-blue-700 font-semibold hover:text-white py-1 px-4 border border-blue-500 hover:border-transparent rounded">
                  redux
