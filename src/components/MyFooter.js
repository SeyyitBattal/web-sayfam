...
const MyFooter = () => {
  ...
  return (
    <div className="footerSection mt-20 bg-white dark:bg-black ">
      <div className="footerSlogan ">
        <h1 className="mb-6 mt-20 text-5xl font-bold flex ml-64">
          Let's work together on <br /> your next product.
        </h1>
      </div>
      <div className="footerLinks footer-mail-links mt-20 flex justify-between">
